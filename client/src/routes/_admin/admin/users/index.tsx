                ...
                <tr key={u.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-1 shrink-0">
                      ...
                      {!u.is_root && u.role !== 'admin' && (
                        <button onClick={() => makeAdminMut.mutate(u.id)} className="rounded p-1.5 hover:bg-purple-50" title="Назначить админом">
                          <Star className="size-4 text-purple-500" />
                        </button>
                      )}
                      {!u.is_root && (
                        <button onClick={() => banMut.mutate(u.id)} className="rounded p-1.5 hover:bg-red-50" title="Забанить">
